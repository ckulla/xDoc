package org.eclipse.xtext.xdoc.generator.latex
...
import org.eclipse.xtext.xdoc.generator.Config
...
import static extension org.eclipse.xtext.xdoc.generator.latex.LatexUtils.*
...
//		tabData.join('''p{«new XFloat(1)/new XFloat(tabData.size)»\textwidth}''', "|")
	...
	def String calcStyle(ImageRef ref) {
		...
		var ppmm = 2.835f // new XFloat(Float::parseFloat("2.835"))
